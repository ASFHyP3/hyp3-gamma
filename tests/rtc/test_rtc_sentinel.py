...
def test_get_product_name():
    ...
    name = rtc_sentinel.get_product_name(
        "S1A_EW_RAW__0SDH_20151118T190420_20151118T190529_008663_00C507_0A5F", None
    )
    assert match("S1A_EW_20151118T190420_DHO_RTC30_G_gpuned_[0-9A-F]{4}$", name)

    name = rtc_sentinel.get_product_name(
        "S1A_EW_RAW__0SDH_20151118T190420_20151118T190529_008663_00C507_0A5F", "foo"
    )
    assert match("S1A_EW_20151118T190420_DHO_RTC30_G_gpuned_[0-9A-F]{4}$", name)
...
def test_get_granule_type():
    ...
    with pytest.raises(ValueError):
        rtc_sentinel.get_granule_type(
            "S1B_WV_OCN__2SSV_20200714T162902_20200714T163511_022469_02AA55_1A7D"
        )

    with pytest.raises(ValueError):
        rtc_sentinel.get_granule_type(
            "S1A_EW_RAW__0SDH_20151118T190420_20151118T190529_008663_00C507_0A5F"
        )
