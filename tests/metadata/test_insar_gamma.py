...
def test_create_look_vector_xmls(insar_product_dir):
    ...
    assert output_files == [
        insar_product_dir
        / "S1AB_20210424T125204_20210430T125122_HHP006_INT80_G_ueF_B4A1_lv_phi.tif.xml",
        insar_product_dir
        / "S1AB_20210424T125204_20210430T125122_HHP006_INT80_G_ueF_B4A1_lv_theta.tif.xml",
    ]
