...
def fix_geotiff_locations(geotiff_dir="PRODUCT"):
    """Fix GAMMA shifting corner coordinates by 1/2 pixel and set GeoTIFF metadata AREA_OR_POINT to Point"""
    back = os.getcwd()
    os.chdir(geotiff_dir)
