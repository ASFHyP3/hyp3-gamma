...
This folder contains radiometric terrain corrected (RTC) products and their associated files. They were generated by the Alaska Satellite Facility (ASF) HYP3 RTC software version [HYP3_VER], running GAMMA release [GAMMA_VER]. The pixel spacing is [SPACING] m.
...
There is an iso.xml file that contains general information about the processing of this product and the resulting files.
