...
## [2.1.2](https://github.com/ASFHyP3/hyp3-rtc-gamma/compare/v2.1.1...v2.1.2)

### Changed
* Files now get uploaded to S3 with a `file_type` tag indicating what the file is
* Files no longer get a prefix based on file type
