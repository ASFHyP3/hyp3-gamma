...
### Changed
* Apply water mask to coherence coefficient first. 
  then produce the validity mask with the masked coherence coefficient only.
  do not use pwr when creating the validity mask. 
