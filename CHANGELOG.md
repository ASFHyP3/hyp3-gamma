...
### Changed
* The water mask is now applied to the coherence coefficient first, which is then used to produce the validity mask. Power is no longer used when creating the validity mask.
