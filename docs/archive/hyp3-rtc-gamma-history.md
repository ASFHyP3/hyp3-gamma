...
All notable changes to the hyp3-rtc-gamma plugin, before being merged into the
general hyp3-gamma plugin, are documented here.

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),
and this project adhered to [PEP 440](https://www.python.org/dev/peps/pep-0440/)
and used [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
